...
$query->bindParam(':ecapacity',$ecapacity,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Table Type has been added.")</script>';
...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Book cafe - Add Tables</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block block-themed">
                                <div class="block-header bg-gd-emerald">
                                    <h3 class="block-title">Add Tables</h3>
                                ...
                                <div class="block-content">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email">Table Type:</label>
                                            <div class="col-12">
                               ...
                               <option value="1" <?php if ($estatus == "1") { echo "selected"; } ?>>Active</option>
