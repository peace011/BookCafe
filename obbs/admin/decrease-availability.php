...
// Decrease the availability of the approved product
// if ($status === "approved") {

//   $sql = "UPDATE tblbook SET BookAval = BookAval - 1 WHERE ID = :eid";
// } elseif ($status === "cancelled") {
//   // You can choose to keep the availability unchanged or set it to 0
//   // Example: Set availability to 0 for cancelled products
//   $sql = "UPDATE tblbook SET BookAval = BookAval WHERE ID = :eid";
// }

// if ($conn->query($sql) === TRUE) {
//   echo '<script>alert("Remark has been updated")</script>';
//    echo '<script>window.location.href = "view-booking-detail.php";</script>';
// } else {
...
//     //  $quer->bindParam(':newAvailability', $newAvailability, PDO::PARAM_INT);
//     //  $quer->bindParam(':eid', $eid, PDO::PARAM_INT);
//     //  $quer->execute();
...
//  Retrieve the current availability of the product

// $sql="SELECT * from tblbook where ID='$booksid'";
// $query = $dbh -> prepare($sql);
// $query->execute();
...
// $bsid=$results['ID'];
// }
// echo('serviceid:'+$_GET['serviceid']);
//  $sql1 = "SELECT SerAvailable FROM tblservice WHERE ID =:serviceid ";
//  $query1 = $conn->prepare($sql1);
//  $query1->bindParam(':serviceid', $serviceid, PDO::PARAM_INT);
//  $query1->execute();
//  $result = $query->fetch(PDO::FETCH_ASSOC);

//  if ($result) {

//      $currentAvailability = $result['BookAval'];
//       var_dump($currentAvailability);
//       //Decrease the availability by 1
//      $newAvailability = $currentAvailability - 1;
//      if ($row->Status === "Approved") {
//      // Update the availability in the database
//      $sql = "UPDATE tblservice SET SerAvailable = :newAvailability WHERE ID = :serviceid";
//      $query = $conn->prepare($sql);
//      $query->bindParam(':newAvailability', $newAvailability, PDO::PARAM_INT);
