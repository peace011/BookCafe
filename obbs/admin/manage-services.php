...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>Book Cafe - Manage Services</title>
        ...
        <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-fixed main-content-narrow">
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Manage Books | Services</h2>
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Manage Books</h3>
                        </div>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-sm-table-cell">Book Price</th>
                                        <th class="d-none d-sm-table-cell">Book Available</th>
...
{               ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                         ...
                                         <td class="d-none d-sm-table-cell">
                                             <a href="edit-services.php?editid=<?php echo ($row->ID); ?>"><button>Edit</button></a>
                                            </td>

                                            <td class="d-none d-sm-table-cell">
                                                <a href="service-details.php?serviceid=<?php echo ($row->ID); ?>" class="btn btn-primary">Details</a>
                                            </td>
                                        </tr>
                                        </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
