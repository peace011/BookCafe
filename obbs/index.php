...
<body>
 	...
 	<div class="banner jarallax"   style="
   /* background-image: url(http://localhost/obbs/Online%20Banquet%20BooKing%20System%20Using%20PHP/obbs/images/banner.jpg);">   */
     <!-- background-image: url(http://localhost/obbs/Bookcafe/obbs/images/ban8.jpg);"> -->
				...
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>come together, enjoy a cup of coffee or tea, and browse through a wide selection of books.</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left w3-agileits-bottom-right">
						<div class="w3-agileits-bottom-left-text">
							<h3>LET THE EXPLORE BEGIN FROM TODAY</h3>
							<p>Seeking a peaceful place to relax, a book cafe can be a delightful retreat.</p>
